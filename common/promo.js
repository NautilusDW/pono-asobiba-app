...
(function() {
  ...
  var GAME_PREVIEWS = [
    ...
    { id: 'card-slide',    title: 'みちつなぎ',
      image: '../assets/images/previews/slide.png',
    ...
    { id: 'card-breakout', title: 'ブロックくずし',
      image: '../assets/images/previews/breakout.png',
  ...
  function showLockedPreview(cardId, onClose) {
    ...
    var primary = preview.image ? resolveAssetPath(preview.image) : '';
    shot.onerror = function() {
      if (placeholder) { shot.onerror = null; shot.src = placeholder; }
    };
    shot.src = primary || placeholder;
    ...
    // 5 秒で auto-close
    autoTimer = setTimeout(close, 5000);
  }
