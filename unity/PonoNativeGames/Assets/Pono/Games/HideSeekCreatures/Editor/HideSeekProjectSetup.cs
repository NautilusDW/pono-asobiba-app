...
namespace Pono.HideSeekCreatures.Editor
{
    public static class HideSeekProjectSetup
    {
        ...
        private const string AppIconPath = "Assets/Pono/AppShell/Branding/app_icon.png";
        ...
        public static void VerifyProject()
        {
            ...
            errors += RequireAsset<Texture2D>(AppIconPath);
        ...
        private static void ConfigureImportedAssets()
        {
            ...
            if (AssetImporter.GetAtPath(AppIconPath) is TextureImporter iconImporter)
            {
                iconImporter.textureType = TextureImporterType.Default;
                iconImporter.alphaIsTransparency = false;
                iconImporter.mipmapEnabled = false;
                iconImporter.wrapMode = TextureWrapMode.Clamp;
                iconImporter.filterMode = FilterMode.Bilinear;
        ...
        private static void ConfigureApplicationIcons()
        {
            ...
            SetIcons(NamedBuildTarget.Standalone, icon);
            SetIcons(NamedBuildTarget.Android, icon);
        }

        private static void SetIcons(NamedBuildTarget target, Texture2D icon)
        {
