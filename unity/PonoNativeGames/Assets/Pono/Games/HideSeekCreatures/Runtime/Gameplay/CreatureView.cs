...
namespace Pono.HideSeekCreatures.Gameplay
{
    ...
    public sealed class CreatureView : MonoBehaviour
    {
        ...
        public void Initialize(CreatureVisualSpec spec, RectTransform parent)
        {
            _spec = spec;
            _rectTransform = (RectTransform)transform;
            _rectTransform.SetParent(parent, worldPositionStays: false);
            _rectTransform.anchorMin = _rectTransform.anchorMax = spec.CenterUv;
            _rectTransform.pivot = new Vector2(0.5f, 0.5f);
            _rectTransform.anchoredPosition = Vector2.zero;
            _rectTransform.sizeDelta = new Vector2(spec.SizeUv.x * 2560f, spec.SizeUv.y * 1440f);
        ...
        private IEnumerator FoundRoutine()
        {
            ...
            while (elapsed < duration)
            {
                ...
                _image.color = Color.Lerp(new Color(1f, 0.94f, 0.75f), Color.white, t);
                yield return null;
            }
            _rectTransform.localScale = Vector3.one;
            _rectTransform.localRotation = Quaternion.identity;
