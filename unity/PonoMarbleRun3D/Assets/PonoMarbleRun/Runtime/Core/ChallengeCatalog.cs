            ...
            return new Dictionary<string, ModeDefinition>(StringComparer.Ordinal)
            {
                ...
                ["starter"] = new ModeDefinition(
                    ...
                    Sample(
                        ...
                        P("starter-low-west-a", MarblePieceKind.Straight, 3, -2, 1, 3),
                        P("starter-underpass-east", MarblePieceKind.Straight, 2, -2, 1, 3),
                        P("starter-underpass-mid", MarblePieceKind.Straight, 1, -2, 1, 3),
                        P("starter-underpass-turn", MarblePieceKind.Curve, 0, -2, 1, 3),
                        P("starter-wave", MarblePieceKind.Wave, 0, -1, 1),
