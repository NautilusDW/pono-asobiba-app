            ...
            return new Dictionary<string, ModeDefinition>(StringComparer.Ordinal)
            {
                ...
                ["starter"] = new ModeDefinition(
                    ...
                    Sample(
                        ...
                        P("starter-high-turn", MarblePieceKind.Curve, 2, -2, 2, 1),
                        P("starter-steps", MarblePieceKind.Steps, 2, -3, 1, 2),
                        P("starter-low-turn-east", MarblePieceKind.Curve, 2, -4, 1, 3),
                        P("starter-elevator", MarblePieceKind.Elevator, 3, -4, 1, 1),
                        P("starter-sky-turn", MarblePieceKind.Curve, 4, -4, 4, 2),
                        P("starter-tornado", MarblePieceKind.Tornado, 4, -3, 1),
                        P("starter-low-turn-west", MarblePieceKind.Curve, 4, -2, 1, 1),
                        P("starter-low-west-slope", MarblePieceKind.Slope, 3, -2, 0, 3),
                        P("starter-underpass-east", MarblePieceKind.Straight, 2, -2, 0, 3),
                        P("starter-underpass-mid", MarblePieceKind.Straight, 1, -2, 0, 3),
                        P("starter-underpass-turn", MarblePieceKind.Curve, 0, -2, 0, 3),
                        P("starter-wave", MarblePieceKind.Wave, 0, -1),
                        P("starter-low-north", MarblePieceKind.Straight, 0, 0),
                        P("starter-ground-mid", MarblePieceKind.Straight, 0, 1),
                        P("starter-ground-north", MarblePieceKind.Straight, 0, 2),
                        P("starter-ground-turn", MarblePieceKind.Curve, 0, 3),
