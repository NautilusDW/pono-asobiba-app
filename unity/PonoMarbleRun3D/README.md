...
- すぐ ころがす: 透明筒、3段上昇エレベーター、高架のなみなみ、透明カーブ、3段下降トルネード、回転羽根をつないだコースです。すぐ試走でき、そのまま自由に改造できます。
...
- ぐるぐるは2段下降、かいだんは1段下降、のぼるみちは1段上昇、トルネードは3段下降、エレベーターは3段上昇です。カーブ・じょうご・各らせん・各上昇機構・透明筒・透明カーブ・なみなみ・回転羽根は標準3D物理の衝突を保ちながら、飛び出しや停止を抑える上限付きの `Rigidbody` 加速度ガイドを仕掛けのトリガー内だけで適用します。
