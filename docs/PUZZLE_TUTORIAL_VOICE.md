...
| `basic_tut_03.mp3` | `そのまま みてね` |
| `basic_tut_04.mp3` | `はなすと もどるよ` |
| `basic_tut_05.mp3` | 長押し成功後の `みえたね` |
| `basic_tut_06.mp3` | `この ピースを タッチ` |
| `basic_tut_07.mp3` | `ヒントを おしてみよう`。最後の「ばしょが ひかるよ」部分は紛らわしいためカット済み |
| `basic_tut_08.mp3` | ヒント使用後の `ひかったね` |
...
- `basic_tut_06.mp3` は、対象ピースとオレンジの案内リングだけを先に描画し、画面で見える間を置いてから吹き出し表示と同時に再生する。
...
- `basic_tut_08.mp3` は、ヒントボタンのクリック処理で実際にヒント演出を出し、発光だけが画面で見える間を置いてから吹き出し表示と同時に再生する。
...
みえたね。
はなすと、パズルに もどるよ。
わからなくなったら、もういちど ながく おしてね。
```

### `tut_basic_04_select_piece`

```text
つぎは、この ピースを タッチしてみよう。
ひかっている ピースを えらんでね。
```

### `tut_basic_05_hint_press`

```text
できたね。
こんどは、「ヒント」ボタンを おしてみよう。
その ピースの ばしょが ひかるよ。
```
