...
- 鍵は自身の**氷の水晶の中**に封じて隠していた。敵には単なる装飾にしか見えず、見つからなかった（氷魔法の能力と一致）
- 救出後、水晶を砕いて鍵を勇者に託す → 「溶岩の奥にも仲間がいる」と炎の妖精救出を促す → カタカナ編（魔王城突入）への布石
...
2. こおりの ようせい「もんばん の すきを ついて
   かぎ を ぬすんで きた わ。」

3. こおりの ようせい「でも かえりみち で
   てした たち に つかまって しまって…」

4. こおりの ようせい「かぎ は こおり の すいしょう に
   とじこめて いた から…」
   （※このタイミングで氷の水晶が砕けて鍵が現れる演出）

5. こおりの ようせい「まおう の てした たち にも
   みつからなかった わ。」

6. こおりの ようせい「この かぎ で、
   おひめさま を たすけだして ね！」

7. こおりの ようせい「ようがん の おく に、
   わたしの なかま が いるの。 たすけて あげて ね！」
```

**演出メモ:**
- 4番目のセリフ表示タイミング (`keyRevealAt=3`) で `🔑` エモジを救出ステージにポップイン + sparkle SE
- グロー色は青〜水色（氷の水晶から出てきたイメージ、`drop-shadow #7ad2ff / #4fc3f7`）
- 鍵は 5〜7 のセリフ中も表示し続け、次妖精への誘導メッセージと共に視覚固定
...
- ザガンは「**火山を噴火させて ふもとの村を焼け**」と命じた
- 彼女は拒否 → ザガンが激怒 → 魔力の鎖で溶岩の底に幽閉
...
3. ほのおの ようせい「かざん が あばれない よう、
   いつも おさえて いた の。」

4. ほのおの ようせい「でも ザガン が、
   かざん を ふんか させろ と めいれい した…」

5. ほのおの ようせい「ふもと の むら が もえて しまう。
   わたし は こばんだ わ。」

6. ほのおの ようせい「すると まりょくの くさり で
   ようがん の そこ に しずめられて しまった の。」

7. ほのおの ようせい「これで さいご の なかま が
   そろった わ ね！」

8. ほのおの ようせい「みんな で ちから を あわせて、
   おひめさま を たすけだそう！」
```
