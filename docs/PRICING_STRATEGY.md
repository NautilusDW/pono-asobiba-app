...
価格・ロードマップ・絶対NG・着金額の4点を1ページで把握できる構成にした。詳細は各章を参照。

### 0.1 推奨価格(3案概要)

3案の概要のみ。詳細な比較(コンセプト・ターゲット・手元残額)は §3.1 を参照。
...
*Small Business Program 15%手数料・日本居住免税事業者を前提*

| 表示価格 | 手数料(15%) | 開発者受取 | 推奨度 |
|---|---|---|---|
| ¥980 | ¥147 | **約 ¥833** | A |
| ¥1,480 | ¥222 | **約 ¥1,258** | B |
| ¥1,980 | ¥297 | **約 ¥1,683** | C |
| ¥600 | ¥90 | **約 ¥510** | シーズンパス |
| ¥1,980 | ¥297 | 1年目 ¥1,258 / 2年目以降 ¥1,683 | 年額サブスク |

補足:
1. ¥980 は免税事業者のため消費税分が実質受取(¥980÷1.10×0.85 ≒ ¥757 が課税事業者換算)
2. 年額サブスクは旧 Auto-Renewable 30%→1年経過後15%が iOS 標準。Small Business Program 適用なら初年度から15%
...
海外と日本の主要な子供向け教育/知育アプリの課金モデル・価格レンジを並べた一次情報。価格レンジは初出のみ ¥ 換算を併記。

| アプリ | 開発元 | 課金モデル | 価格 | 確度 |
|---|---|---|---|---|
| Endless Alphabet | Originator | Free DL + 一括 IAP | 段階解放 [1] | 高 |
| Tinybop The Human Body | Tinybop | 買い切り + 年額サブスク | $3.99 / 年 $9.99 | 高 |
| Slice Fractions | Ululab | 純買い切り | $3.99-$5.99 [2] | 高 |
| LOOPIMAL / BANDIMAL | YATATOY | 純買い切り | $3.99-$4.99 | 高 |
| Monument Valley(参考) | ustwo | 買い切り + DLC | $3.99-$4.99 [3] | 高 |
| Pok Pok Playroom | Pok Pok | サブスク | 月 $3.99 / Lifetime $49.99 | 高 |
| Sago Mini / Toca Boca → Piknik | Spin Master | サブスク統合 | 月 $11.99 | 高 |
| Kiddopia | Paper Boat Apps | サブスク | 月 $12.99 / 年 $79.99 [4] | 中 |
| タッチ!あそベビー | WAO CORPORATION | 買い切り | 数百〜千円台 [5] | 高 |
| あそんでまなべる 日本地図パズル | Digital Gene | 買い切り | 数百円〜 | 高 |
| おやこでリズムえほんシリーズ | Smart Education | 買い切り or 無料DL+IAP | アプリにより異なる | 中 |
| すみっコぐらし系教育アプリ | サンエックス系 | サブスク | 月 ¥480 前後 | 中 |
| シンクシンク | Wonderfy | フリーミアム + サブスク | 月 ¥980 | 高 |
| トドさんすう | Enuma | 1年買い切り + 月額サブスク | 1年 ≒ ¥8,800 [6] | 高 |
| ワンダーボックス | ワンダーラボ | サブスク(教材付き) | 月 ¥3,700〜 | 高 |
| Peekaboo Barn | Night & Day Studios | 純買い切り(2008年〜) | $1.99 前後 [7] | 高 |

脚注:
1. Endless Alphabet 本体は無料、Endless Numbers IAP は $6.99 / $14.99 / $11.99 の段階解放
2. Slice Fractions は School Edition $5.99 を別途併売
3. Monument Valley は DLC $1.99 を追加販売
4. 古いソースに $7.99 表記あり、現行は $12.99 主
5. タッチ!あそベビーはシリーズ累計 22M DL(2025年12月)
6. トドさんすうは 2年プランを 2024年6月で終了し、1年プランに集約
7. Peekaboo Barn は 18年ロングテール

### 1.2 重要トレンド(2024-2026)
...
**示唆**: 5項目を全て揃えれば、日本市場で月 50-200万円、海外含め月 100-500万円は射程圏内(推測)。最低でも (1)(3)(5) は必ず満たす設計にする。
...
| アプリ | リリース | 価格 | モデル |
|---|---|---|---|
| Endless Alphabet | 2013 | Free DL + IAP | フリーミアム+IAP |
| Toca Boca初期 3作 | 2011 | $0.99-$2.99 | 純買い切り |
| Tinybop The Human Body | 2013 | $3.99 + 年 $9.99 | 三層共存 |
| DragonBox Algebra 5+ | 2012 | $4.99-$9.99 | 純買い切り→Kahoot傘下 |
| Monument Valley | 2014 | $3.99-$4.99 + DLC | プレミアム単発 |
| Slice Fractions | 2014 | $3.99-$5.99 | 純買い切り |
| LOOPIMAL / BANDIMAL | 2015-2017 | $3.99-$4.99 | 純買い切り |
| Peekaboo Barn | 2008 | $1.99 前後 | 純買い切り |
| タッチ!あそベビー | 2013 | 買い切り(複数パック) | 無料お試し + 買い切り |
| あそんでまなべる 日本地図パズル | 2012 | 数百円〜 | 純買い切り |
| おやこでリズムえほんシリーズ | 2012 | 買い切り or IAP | ハイブリッド |
| トドさんすう | 2014 | 1年 ≒ ¥8,800 + 月額 | 期間買い切り |

各事例の学び:
1. Endless Alphabet: "無料お試し→一括IAPで全解放"はストアで自然に通る。シリーズ化(Reader/Numbers/Spanish/Wordplay)で横展開
2. Toca Boca初期 3作: 5年で累計 140M DL(全32アプリ)、頂点でサブスク移行
3. Tinybop The Human Body: バンドル(Tinybop Collection 1-10)も併売
4. DragonBox Algebra 5+: ニッチ学習でも $5-$10 で $18M 買収
5. Monument Valley: 2年で $14.4M 売上、子供向けではないが象徴例
6. Slice Fractions: School Edition $5.99。Apple Editor's Choice + Parents' Choice Gold、B2C+B2B 二本立て
7. LOOPIMAL / BANDIMAL: 個人スタジオ × 極小ラインナップ × 芸術的品質でロングテール
8. Peekaboo Barn: リリース 18 年経過後もストア継続。"何も足さない"を売る究極形
9. タッチ!あそベビー: シリーズ累計 22M DL(2025/12時点)、日本買い切りの代表
10. あそんでまなべる 日本地図パズル: 14年現役、学校教科直結テーマ × シリーズ化
11. おやこでリズムえほんシリーズ: 童謡/Eテレ等の既存IPと組合せ
12. トドさんすう: 「完全サブスク移行」と誤解されがちだが、実は買い切り併存(2年プランは2024年6月終了)。日本買い切り事例として加算可

### 2.3 単独買い切り vs シリーズ買い切り の構造比較

単独タイトルで勝負するか、シリーズで積み上げるかは、必要品質・開発期間・リスク分散の3軸で大きく異なる。以下は両モデルの構造的差分を整理した表。
...
個人開発の買い切りモデルで現実的に到達可能な月商・年商と、各レンジに到達するための必要条件を整理する。
...
**目標設定**: 1-2年目で月 10-30万円、3-5年目で月 50-200万円(シリーズ化が進めば)。YATATOY / Slice Fractions レベル(年 600万-2,000万円)を現実的ベンチマークに置く。Monument Valley は狙わない。
...
買い切り型アプリが辿る5フェーズと、各フェーズで分岐する戦略パターンを整理する。
...
価格・コンセプト・ターゲット・手元残額の4軸で3案を一次情報として整理した詳細表。サマリは §0.1、§11 で再評価。
...
本体買い切り・シーズンパス・年額サブスクの3層を並列で持ち、ユーザーが自由に選べる設計。各層の役割は次のとおり。
...
### 4.2 Tinybop / Pango が成立させた「三層共存」の鍵
...
**注記**: Apple Newsroom(2022年12月)では「175ストアフロント / 45通貨」表記もあり、公式内に表記揺れがある。基本的に「世界中で買える」と理解しておけば実務上は問題ない。

### 5.3 セール実施手順(App Store Connect)

App Store Connect 上で Temporary Price Change を設定する手順と、設定時の制約・注意点を整理する。

1. App Store Connect → Monetization → Pricing and Availability
2. Price Schedule [+] を選択
3. Temporary Price Change を設定
...
サブスクを将来導入した時の値上げ規約を、値上げ幅と金額幅の AND 条件で整理する。

**ユーザー同意不要の条件**(AND条件):
- 過去 12 か月以内に値上げを行っていない
- 値上げ額が「現価格の 50% 超」かつ「$5(¥800)/$50(¥8,000)超」の両方を満たさない
...
Featured 枠を狙うための申請ルート・提出期限・編集対象を整理する。個人開発者の現実的な期待値は最後の項目を参照。

1. App Store Connect → Featuring Nominations から申請
2. 最低 2 週間前、最大 3 か月前まで提出可
...
**注記**: Omnibus Directive 準拠の文脈。EU 全加盟国ではない(Germany, Italy, Spain 等は含まれない)点に注意。
...
**示唆**: 「iOS は値引きしないが Google Play だけ夏休みセール」は完全に許容される。Android 独自の販促視覚を活用する。
...
3年スパンで本体価格を緩やかに引き上げる理想形。各値上げの直前に明確な機能追加を当てて「値上げの理由」を可視化する。

1. **0ヶ月**: ¥1,480 で発売
2. 新ステージ追加・キャラ追加・お絵かき機能拡充
3. **12ヶ月**: ¥1,780 に値上げ(+20%、最低30日前告知、Grandfather保証明記)
4. さらに新ゲーム1本追加
5. **24ヶ月**: ¥1,980 に値上げ(+11%)
6. コンテンツが2倍以上になった節目
7. **36ヶ月**: 「ポノあそびば 2」として別 SKU 化(¥2,480)、旧版50%OFFクーポン

### 7.5 日本の景品表示法・二重価格表示リスク【法務】

日本市場でセール訴求する際に踏まえるべき法令・ガイドラインを整理する。ポノでの実装ルールは末尾の表を参照。
...
**注記**: 実際の摘発事例は大手 EC・大手小売中心。個人開発者の摘発例は確認できなかったが、「理論的リスクあり、実態は大手中心」として理解。安全側に倒して運用する。
...
「値段が安すぎた」と感じた時に焦って値上げするのではなく、価値追加→告知→値上げの順を踏むための8ステップ。

1. 3-6ヶ月は値段を動かさず売上推移を観察
2. その間に1つ明確な追加価値(新ステージ/新ゲーム/新キャラ)をリリース
3. LP・App Store スクショ・リリースノートで「コンテンツが◯倍になりました」と価値増加を可視化
4. 最低30日前に「○月○日より新価格 ¥△△△に改定」とアプリ内告知
5. 現価格期間に駆け込み購入セール(元値非表示)
6. 値上げ実施
7. 既存購入者は永続的に新コンテンツも無料 — LP に明記
8. 値上げ幅は1回 +30-50% まで、年1回が上限

### 7.8 リカバリー手順 — 「高すぎた」と気づいた時

「値段が高すぎた」と感じた時の対応7ステップ。安易な値下げは「待てば下がる」アンカーを定着させるため、価格以外の打ち手を先に試す。

1. 即値下げは禁忌。まず「なぜ売れないか」を分解(認知 / 価値訴求 / UX 摩擦)
2. 値段以外で解決できないか3-6ヶ月試す(LP改善 / 無料体験ステージ拡充 / レビュー対策 / SNS発信)
3. それでも売れない場合、値下げは「一回・恒久的」にして二度と動かさない
4. 値下げの「理由」を必ず明示
5. 既存購入者への埋め合わせを必ずセット(限定特典・優先アクセス等)
6. 値下げ幅は -30% 程度まで、-50% 超は避ける
7. 代替案: 無料体験版リリースで実質ハードルを下げる(本体価格は維持)

---

## 8. 年間プロモーションカレンダー案

### 8.1 月別「セールが効くタイミング」表

各月のイベント・施策・割引率を一覧化。最右列はセール実施の可否(○=やる/❌=避ける)。補足条件は表外の脚注に整理した。

| 月 | イベント | 施策 | 割引率 | 可否 |
|---|---|---|---|---|
| 1月 1-7日 | 新年・習慣化需要 | 新年セール: 新しい学習習慣 | 30% | ○ |
| 1月 末〜 | Apple 新学期を始めよう | 新ステージ追加 + LP テコ入れ | — | ○ |
...
| 4/25-5/9 | Google Play GW クーポン | 課金導線UI改善 + 受け皿準備 | — | ○ |
| 6月 | 平常運転 | LP改善・素材整備 | — | ○ |
...
補足:
1. 1月 1-7日 は年最大の起爆剤。年1-2回の起爆として 50% も可。
2. 1月 末〜 の Apple 新学期は 1/29-4/8 のハード販促期。
3. 3月 上旬 は進研ゼミ4月号本格セールが3月中旬に開始するため、その前に出して先行優位を取る。
4. 4/25-5/9 の Google Play GW クーポンは 50%OFF・最大 ¥600 引き。
5. 12月20-29日 の課金導線は1月起爆用に温存する設計。
...
## 11. 段階値上げ戦略とコンテンツ量への対応 (2026-06-11 追記)

**追記の経緯**: 「競合は100ゲーム級のボリュームがあるのに対してポノはMVP 5本で個人開発。ボリューム差を踏まえて初期価格を下げるべきか、また『最初に予告すれば2-3段階の値上げは許されるか』」というユーザーの2つの仮説を別ワークフローで検証した結果を反映。

### 11.1 ユーザー直観の検証結果

| 仮説 | 判定 |
|---|---|
| **「ボリューム少なめ＝安め設定すべき」** | **CONDITIONAL YES** — 海外少コンテンツ成功例（Prune $3.99/Pocket City $2.99/Monument Valley $3.99/Alto's Odyssey $4.99）の中央値は $3.99 帯。GNOG $9.99/9レベルは「短くて高い」批判ゾーン。 |
| **「最初に予告すれば2-3段階値上げOK」** | **CONDITIONAL YES、ただし3段階の前例はほぼ皆無、2段階が業界標準** — Factorio $20→$30、Bear 2、No Rest for the Wicked $40→$60 はいずれも2段階。3段階予告→完遂の成功前例は今回調査で発見できず。 |

### 11.2 初期価格の改定推奨

※ §3 の推奨を §11 で更新。前回B案 ¥1,480 → **¥980 への引き下げを推奨**。新旧推奨度の差分のみを掲載(価格・コンセプトの詳細は §3.1 参照)。

| 案 | 価格 | §3判定 → §11判定 |
|---|---|---|
| **A'（新推奨）** | **¥980** | △ → **◎** Pocket City型、親の衝動買い圏内 |
| B（旧推奨） | ¥1,480 | ◎ → △ 外部認証なしには高め |
| C | ¥1,980 | ○ → × MVP 5本では正当化困難 |

**引き下げの根拠**:
1. 親の単発購入心理上限 ≈ $10(¥1,500)に対し ¥980 は安全圏
2. 海外少コンテンツ成功事例の中央値が $3.99(¥600-800)
3. ポノは Apple Design Award 等の外部認証をまだ持たない
4. ¥980 → ¥1,480 への将来値上げ余地を残せる

### 11.3 少コンテンツでリリースした成功/失敗事例

少ない初期コンテンツでも安価で出して長期に伸ばした成功例と、内容に対して高価で批判を受けた失敗例。詳細な結果説明は表の下に列挙。

| アプリ | 初期コンテンツ | 初期価格 | 結果 |
|---|---|---|---|
| Prune (2015) | 48レベル | $3.99 | ◎ |
| Pocket City (2018) | 都市シム | $2.99 | ◎ |
| Monument Valley (2014) | 10ステージ | $3.99 | ◎ |
| Threes! (2014) | 1モード | $1.99 | ◎ |
| Alto's Odyssey (2018) | 1モード | $4.99 | ◎ |
| Stardew Valley iOS (2018) | 1.3 | $7.99 | ○ |
| Endless Alphabet (2013) | 初期少数 | $5.99→$8.99 | △ |
| Lake (2021) | — | $19.99 | × |
| GNOG | 9レベル | $9.99 | × |

結果の詳細:
1. Prune: 1人開発、Time誌GOTY、Apple GOTY
2. Pocket City: 1人開発、IAPなし、Toucharcade "Essential"
3. Monument Valley: Ustwo、2年で約$14.3M、ただし追加DLCで☆1爆撃
4. Threes!: 3人開発、Apple GOTY 2014、Design Award
5. Alto's Odyssey: Snowman、広告IAPゼロ、Apple Design Award
6. Stardew Valley iOS: 1人開発、1.4/1.5/1.6 を全て無料追加、iOS 4.8/5
7. Endless Alphabet: Originator、初期は☆1の温床(避けるべきパターン)
8. Lake: 「slow・薄い」批判
9. GNOG: 「短くて高い」批判共通
...
| 事例 | 段階 | 予告 | 結果 |
|---|---|---|---|
| **Factorio** (2018) | $20→$30 (+50%) | 事前予告・完遂 | 成功。「絶対セールしない」でブランド化 |
| **Bear 2** (2023) | 月$1.49→$2.99 (+100%) | 新規のみ値上げ・既存据置を明言 | 成功（模範例） |
| **No Rest for the Wicked** | EA $40→正式$60 (+50%) | 強い予告 | 概ね成功 |
| **Monument Valley Forgotten Shores** | 既存+$1.99 IAP | 告知不足 | ☆1爆撃、公式が遺憾表明 |
| **ARK: Survival Evolved** (2017) | $30→$60 (+100%) | 予告あるが機能未充足 | 炎上 |
| **Canva Teams** (2024) | $120→$500 (+300%) | 予告なし急騰 | 2024年10月に部分撤回 |

**業界標準**: 2段階・+50%以内・最低6ヶ月間隔。3段階予告→完遂の成功前例ゼロ。

### 11.5 法令・規約上の前提

- **【消費者庁 2020/12/25執行方針】** 将来価格を訴求するなら、(a) 実現性のある販売計画書面の社内保存、(b) 値上げ後の継続実販売（弁護士実務目安2週間以上）、(c) 不可抗力以外で未実施は景表法5条2号（有利誤認）リスク。
- **【特商法2022/6改正】** サブスクは最終確認画面に「2回目以降の代金」表示義務。
- **【Apple App Store】** サブスクは年1回・$5かつ50%以内なら通知のみ、それ以上はオプトイン同意必須。買い切り(Non-Consumable IAP)はApp Store Connect の Price Schedule で将来日付の価格変更を自由に予約可能。
- **【前提確認】** ポノが PWA 直販（Stripe等）なら Apple/Google 規約は直接適用外。Stripe Coupon/Promotion Code で柔軟に運用可能。**配信経路の確定が前提**。

### 11.6 推奨カレンダー3案

案X(★第一推奨) / 案Y / 案Z の3パターンを、価格遷移・既存購入者扱い・リスク・想定収益で比較する。

| 案 | 価格遷移 | 既存購入者扱い | リスク | 想定収益例 |
|---|---|---|---|---|
| **X(★第一推奨)** | ¥980 → ¥1,480 (6ヶ月間隔) | 完全 grandfathering(Bear 2 模範例) | 低(Factorio/Bear 2 圏)。日本子供向け前例ゼロのSNS炎上未検証リスクは残る | 100人×¥980 + 150人×¥1,480 = ¥31万 |
| Y | ¥980 → ¥1,480 → ¥1,980 (各6ヶ月) | 完全 grandfathering | **高**。3段階予告→完遂の業界前例ゼロ。Canva型撤回コスト | 完遂すれば最大化、未達なら逆効果 |
| Z(Procreate型) | ¥980 固定、無料アプデで増やす(初週のみ ¥480 発売記念) | 全員同一価格 | **最低**。法令・規約・心理すべて安全圏 | 単価固定、口コミ・レビューで長期的に伸びる(Pocket City型) |

案X の必須要件: 0ヶ月時点でストアページに「ローンチ価格・6ヶ月後にコンテンツ追加と共に¥1,480へ」明示、6ヶ月時点で +3ミニゲーム追加と同時に移行、販売計画書面の社内保存、各段階での明示的コンテンツ追加。

### 11.7 段階値上げの代替戦略トップ3

| 順位 | 戦略 | 適合度 | 理由 |
|---|---|---|---|
| 1位 | DLC方式（本体¥980固定 + 新ステージ¥240/個、任天堂Booster Pass型） | **◎** | 既存購入者に心理的負担ゼロ、新規組との不公平感ゼロ |
| 2位 | 発売記念セール → 通常価格固定（¥680→¥980、Procreate型） | **◎** | 「上がる」より「今だけ安い」のほうが親フレンドリー、法的リスク最低 |
| 3位 | シリーズ展開（1年後「ポノ・かず編」「ポノ・ことば編」分割、Originator型） | △→将来◎ | 現フェーズではブランド分散リスクで早い |

**避けるべき代替案**:
- Tip Jar / 寄付 × Apple規約3.2.1(vii)で実質禁止
- マイクロサブスク △ 未就学児卒業で離脱しやすい
- クラウドファンディング △ 既にリリース済PWAには物語性が弱い

### 11.8 失敗回避リスト

- 既存ユーザーに追加コンテンツを別料金 → Monument Valley Forgotten Shores 型☆1爆撃
- 「6単語しかない」中途半端リリース → Endless Alphabet 型炎上
- 機能未充足のまま値上げ → ARK 2017型炎上
- 予告なし急騰 → Canva 2024型撤回コスト
- 買い切り→突然サブスク移行 → Sago Mini 2024型ユーザー困惑

### 11.9 結論

**今週中に「¥980ローンチ + 案X の2段階予告（6ヶ月後¥1,480、既存者は新ゲーム無料）」か「¥980固定 + DLC ¥240/本売り（Procreate + 任天堂Pass型）」のどちらで行くか、ポノの配信経路（PWA直販 / iOS App Store / Stripe）を確定した上で意思決定すべき。**
...
海外の主要な買い切りアプリ・買収事例の公式ページや報道資料を掲載する。
...
日本市場で長寿命の買い切りアプリ・シリーズの公式ページを掲載する。
...
### 12.3 iOS App Store 公式

Apple Developer 公式の価格・サブスク・プロモコード・Featured 関連の一次情報を掲載する。
...
Google Play support の Sales・価格・プロモ・実験・Play Pass 関連の一次情報を掲載する。
...
Notion / Figma / 1Password / iPhone 等の代表的な価格改定・値下げ事件の一次情報や論評記事を掲載する。
...
景品表示法 8週間ルール・改正景表法・将来価格を比較対照とする二重価格規制の解説・一次情報を掲載する。
...
季節販促タイミング・教育アプリ市場規模・子供のインターネット利用時間に関する統計・調査を掲載する。
...
個人開発者向けの一括 vs サブスク論や Indie App ランキングなど、参考になる外部論考を掲載する。
...
原調査から本書に反映する過程で修正した主な訂正点を整理する。

| 項目 | 旧記述 | 新記述 |
|---|---|---|
| Endless Alphabet 価格 | $9.99 | **$8.99** |
| Kiddopia 価格 | $7.99/月 | **$7.99-$12.99/月のレンジ** |
| トドさんすう | 完全サブスク移行 | **1年買い切り併存** |
| Toca/Sago 売却額 | $24M+ で売却 | **金額非公開**(削除) |
| Endless Alphabet DL | 1億DL | **シリーズ累計推定**(トーンダウン) |
| サブスク値上げ閾値 | 50%以下 | **「50%超 AND $5/$50超」のAND条件** |
...
| iPhone値下げ事件 | Jobsの冷淡な対応 | **翌日に公開謝罪+$100クレジット** |
