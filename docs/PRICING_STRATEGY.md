...
前回B案 ¥1,480 → **¥980 への引き下げを推奨**:

| 案 | 価格 | 1本単価(5本前提) | 判定 |
|---|---|---|---|
| **A'（新推奨）** | **¥980** | ¥196/本 | ◎ Pocket City型「驚きの安さ+無料アプデで信頼構築」、親の衝動買い圏内 |
| B（旧推奨） | ¥1,480 | ¥296/本 | △ 外部認証(Apple Design Award等)なしには高め |
| C | ¥1,980 | ¥396/本 | × MVP 5本では正当化困難 |
...
| アプリ | 初期コンテンツ | 初期価格 | 結果 |
|---|---|---|---|
| Prune (1人開発, 2015) | 48レベル | $3.99 | Time誌GOTY、Apple GOTY |
| Pocket City (1人開発, 2018) | 都市シム | $2.99 / IAPなし | Toucharcade "Essential" |
| Monument Valley (Ustwo, 2014) | 10ステージ | $3.99 | 2年で約$14.3M、ただし追加DLCで☆1爆撃 |
| Threes! (3人, 2014) | 1モード | $1.99 | Apple GOTY 2014、Design Award |
| Alto's Odyssey (Snowman, 2018) | 1モード | $4.99 / 広告IAPゼロ | Apple Design Award |
| Stardew Valley iOS (1人, 2018) | 1.3 | $7.99 (¥960) | 1.4/1.5/1.6 を全て無料追加、iOS 4.8/5 |
| Endless Alphabet (Originator, 2013) | 初期少数 | $5.99→$8.99 | 初期は☆1の温床（避けるべきパターン） |
| Lake ($19.99, 2021) | — | $19.99 | 「slow・薄い」批判 |
| GNOG | 9レベル | $9.99 | 「短くて高い」批判共通 |
...
#### 案X（★第一推奨）: 2段階 ¥980 → ¥1,480、6ヶ月間隔

- **0ヶ月**: ¥980 でローンチ。ストアページに「ローンチ価格・6ヶ月後にコンテンツ追加と共に¥1,480へ」明示
- **6ヶ月**: +3ミニゲーム追加と同時に ¥1,480 へ移行
- **既存購入者**: 完全 grandfathering（追加ゲーム無料、Bear 2 模範例）
- **必須**: 販売計画書面の社内保存、各段階での明示的コンテンツ追加
- **リスク**: 低（Factorio/Bear 2の成功圏）。日本子供向けに前例ゼロのため保護者SNS炎上の未検証リスクは残る
- **想定収益例**: 初期100人×¥980 + 値上げ後150人×¥1,480 = ¥31万

#### 案Y: 3段階 ¥980 → ¥1,480 → ¥1,980、各6ヶ月

- **リスク高**。3段階予告→完遂の業界前例ゼロ。コンテンツ追加が間に合わないと景表法リスク。Canva型撤回コスト
- 完遂すれば収益最大化、未達ならブランド毀損で逆効果

#### 案Z: 段階値上げをしない（Procreate型）

- ¥980 で固定、無料アプデで増やす
- ローンチ初週のみ ¥480 の発売記念価格 → ¥980 固定
- **リスク最低**。法令・規約・心理すべて安全圏
- 単価固定だが口コミ・レビューで長期的に伸びる（Pocket City型）
