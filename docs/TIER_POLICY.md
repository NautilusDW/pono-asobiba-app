...
|---|---|---|---|
| **free** | 8 食材（主菜 3 + 副菜 3 + フルーツ 2） | 1 箱 / NPC なし | 基本の顔パーツ + ピック |
| **book** | 12 食材（free + 4 食材） | 3 箱 / NPC 3 種 | 追加の顔セット・のり形状・かざり |
| **sub** | 全 30 食材 | 全箱 / 全 NPC | 全解放 |

- free の食材は「タコウインナー / ハンバーグ / たまごやき / キャベツ / プチトマト / ブロッコリー / いちご / バナナ」。
- book は「からあげ / エビフライ / にんじんいんげん / みかん」を追加する。
...
- free は基本音色とリズム体験を残し、book で追加音色・ペンタ・和音を解放する。リズム曲は現状「かえるのうた」のみなので free/book 共通。
...
- `docs/BENTO_CONTENT_PLAN.md` — free 8 食材 / book 12 食材 + のり・かざりの minTier 整理
...
- bento を free 8 食材 / book 12 食材 + 追加箱/NPC/のり・かざりに変更。
...
- quizland / bento / oto は v3 の free = book を維持（v3.2 で oto / bento は再度 book 追加復帰）。
