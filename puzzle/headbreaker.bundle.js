var headbreaker = (() => {
  ...
  // node_modules/headbreaker/src/pair.js
  var require_pair = __commonJS({
    "node_modules/headbreaker/src/pair.js"(exports, module) {
      function isNull(x, y) {
  ...
  // node_modules/headbreaker/src/between.js
  var require_between = __commonJS({
    "node_modules/headbreaker/src/between.js"(exports, module) {
  ...
  // node_modules/headbreaker/src/vector.js
  var require_vector = __commonJS({
    "node_modules/headbreaker/src/vector.js"(exports, module) {
  ...
  // node_modules/headbreaker/src/anchor.js
  var require_anchor = __commonJS({
    "node_modules/headbreaker/src/anchor.js"(exports, module) {
      ...
      var Anchor = class _Anchor {
         ...
         * @returns {Anchor}
         */
        static import(vector2) {
          return anchor(vector2.x, vector2.y);
        }
      };
      function anchor(x, y) {
  ...
  // node_modules/headbreaker/src/insert.js
  var require_insert = __commonJS({
    "node_modules/headbreaker/src/insert.js"(exports, module) {
      var Tab = {
        isSlot: () => false,
        isTab: () => true,
        isNone: () => false,
  ...
  // node_modules/headbreaker/src/prelude.js
  var require_prelude = __commonJS({
    "node_modules/headbreaker/src/prelude.js"(exports, module) {
  ...
  // node_modules/headbreaker/src/connector.js
  var require_connector = __commonJS({
    "node_modules/headbreaker/src/connector.js"(exports, module) {
      var { pivot } = require_prelude();
  ...
  // node_modules/headbreaker/src/structure.js
  var require_structure = __commonJS({
    "node_modules/headbreaker/src/structure.js"(exports, module) {
      var { Slot, Tab, None } = require_insert();
      var { orthogonalMap } = require_prelude();
  ...
  // node_modules/headbreaker/src/piece.js
  var require_piece = __commonJS({
    "node_modules/headbreaker/src/piece.js"(exports, module) {
      var Pair = require_pair();
      var { anchor, Anchor } = require_anchor();
      var { None } = require_insert();
      var { Connector } = require_connector();
      var Structure = require_structure();
      var { itself, orthogonalTransform } = require_prelude();
      var Piece = class _Piece {
        ...
        */
         ...
         */
        recenterAround(anchor2, quiet = false) {
          const [dx, dy] = anchor2.diff(this.centralAnchor);
  ...
  // node_modules/headbreaker/src/validator.js
  var require_validator = __commonJS({
    "node_modules/headbreaker/src/validator.js"(exports, module) {
      var Puzzle = require_puzzle();
      ...
      var PuzzleValidator = class _PuzzleValidator extends AbstractValidator {
        /**
        ...
        static equalDiffs([dx0, dy0], [dx, dy]) {
          return Pair.equal(dx0, dy0, dx, dy, _PuzzleValidator.DIFF_DELTA);
        }
      };
  ...
  // node_modules/headbreaker/src/size.js
  var require_size = __commonJS({
    "node_modules/headbreaker/src/size.js"(exports, module) {
      var Vector = require_vector();
  ...
  // node_modules/headbreaker/src/shuffler.js
  var require_shuffler = __commonJS({
    "node_modules/headbreaker/src/shuffler.js"(exports, module) {
      ...
      var columns = (pieces) => {
        ...
        for (let destination of destinations) {
          if (!columns2.get(destination.x)) {
            columns2.set(destination.x, destinations.filter((it) => it.x == destination.x));
          }
          const column = columns2.get(destination.x);
      ...
      var line = (pieces) => {
        const destinations = pieces.map((it) => it.centralAnchor.asVector());
        const columns2 = new Set(destinations.map((it) => it.x));
        const maxX = Math.max(...columns2);
        const minX = Math.min(...columns2);
        const width = (maxX - minX) / (columns2.size - 1);
  ...
  // node_modules/headbreaker/src/drag-mode.js
  var require_drag_mode = __commonJS({
    "node_modules/headbreaker/src/drag-mode.js"(exports, module) {
      var connector = require_connector();
  ...
  // node_modules/headbreaker/src/puzzle.js
  var require_puzzle = __commonJS({
    "node_modules/headbreaker/src/puzzle.js"(exports, module) {
      var { Anchor } = require_anchor();
      var Piece = require_piece();
      var { NullValidator } = require_validator();
      var { vector, ...Vector } = require_vector();
      var { radius } = require_size();
      var Shuffler = require_shuffler();
      var dragMode = require_drag_mode();
      var { Connector, noConnectionRequirements } = require_connector();
  ...
  // node_modules/headbreaker/src/axis.js
  var require_axis = __commonJS({
    "node_modules/headbreaker/src/axis.js"(exports, module) {
      var Vertical = {
        /**
         * @param {import("./vector").Vector} vector
         * @returns {number}
  ...
  // node_modules/headbreaker/src/outline.js
  var require_outline = __commonJS({
    "node_modules/headbreaker/src/outline.js"(exports, module) {
      var Piece = require_piece();
      var { vector, ...Vector } = require_vector();
      ...
      var Squared = class {
        ...
        draw(piece, size = 50, borderFill = 0) {
          ...
          return [
            ...
            0 - offset.y,
            2,
            select(piece.up, -1 - offset.y, 1 - offset.y, 0 - offset.y),
            3,
            0 - offset.y,
            4 + offset.x,
            0 - offset.y,
            4 + offset.x,
            1,
            sr(piece, 5 + offset.x, 3 + offset.x, 4 + offset.x),
            2,
            4 + offset.x,
            3,
            4 + offset.x,
            ...
            4 + offset.y,
            2,
            select(piece.down, 5 + offset.y, 3 + offset.y, 4 + offset.y),
            1,
            4 + offset.y,
            0 - offset.x,
            4 + offset.y,
            0 - offset.x,
            3,
            sl(piece, -1 - offset.x, 1 - offset.x, 0 - offset.x),
            2,
            0 - offset.x,
            1
  ...
  // node_modules/headbreaker/src/sequence.js
  var require_sequence = __commonJS({
    "node_modules/headbreaker/src/sequence.js"(exports, module) {
      var { Tab, Slot, None } = require_insert();
      function fixed(_n) {
        return Tab;
      }
      function flipflop(n) {
  ...
  // node_modules/headbreaker/src/metadata.js
  var require_metadata = __commonJS({
    "node_modules/headbreaker/src/metadata.js"(exports, module) {
  ...
  // node_modules/headbreaker/src/manufacturer.js
  var require_manufacturer = __commonJS({
    "node_modules/headbreaker/src/manufacturer.js"(exports, module) {
      var Puzzle = require_puzzle();
      var Piece = require_piece();
      var { Anchor } = require_anchor();
      var { anchor } = require_anchor();
      var { fixed, InsertSequence } = require_sequence();
  ...
  // node_modules/headbreaker/src/image-metadata.js
  var require_image_metadata = __commonJS({
    "node_modules/headbreaker/src/image-metadata.js"(exports, module) {
      var { vector } = require_vector();
  ...
  // node_modules/headbreaker/src/spatial-metadata.js
  var require_spatial_metadata = __commonJS({
    "node_modules/headbreaker/src/spatial-metadata.js"(exports, module) {
      var Vector = require_vector();
      var Piece = require_piece();
      var Pair = require_pair();
      var { PuzzleValidator } = require_validator();
      ...
      var absolutePosition = (piece) => Vector.equal(piece.centralAnchor.asVector(), piece.metadata.targetPosition);
  ...
  // node_modules/headbreaker/src/canvas.js
  var require_canvas = __commonJS({
    "node_modules/headbreaker/src/canvas.js"(exports, module) {
      var Pair = require_pair();
      var Piece = require_piece();
      var Puzzle = require_puzzle();
      var Manufacturer = require_manufacturer();
      var { twoAndTwo } = require_sequence();
      var Structure = require_structure();
      var ImageMetadata = require_image_metadata();
      var { vector, ...Vector } = require_vector();
      var Metadata = require_metadata();
      var SpatialMetadata = require_spatial_metadata();
      var { PuzzleValidator, PieceValidator } = require_validator();
      var { Horizontal, Vertical } = require_axis();
      var Shuffler = require_shuffler();
      var { diameter } = require_size();
      var { itself } = require_prelude();
      var { Classic } = require_outline();
      var Canvas = class {
        /**
         * @private
  ...
  // node_modules/headbreaker/src/painter.js
  var require_painter = __commonJS({
    "node_modules/headbreaker/src/painter.js"(exports, module) {
  ...
  // node_modules/headbreaker/src/dummy-painter.js
  var require_dummy_painter = __commonJS({
    "node_modules/headbreaker/src/dummy-painter.js"(exports, module) {
      var Canvas = require_canvas();
      var Piece = require_piece();
  ...
  var require_Node = __commonJS({
    "node_modules/konva/lib/Node.js"(exports) {
      ...
      var Node = (function() {
        ...
        Node2.prototype._isListening = function() {
        ...
        Node2.prototype.shouldDrawHit = function() {
        ...
        Node2.prototype._setAttr = function(key, val) {
        ...
        Node2.prototype.startDrag = function(evt) {
  ...
  var require_Container = __commonJS({
    "node_modules/konva/lib/Container.js"(exports) {
      ...
      var Container = (function(_super) {
        ...
        Container2.prototype.drawScene = function(can, top, caching) {
        ...
        Container2.prototype.drawHit = function(can, top, caching) {
        ...
        Container2.prototype._drawChildren = function(canvas, drawMethod, top, caching, skipBuffer, skipComposition) {
        ...
        Container2.prototype.shouldDrawHit = function(canvas) {
  ...
  var require_Stage = __commonJS({
    "node_modules/konva/lib/Stage.js"(exports) {
      ...
      var Stage = (function(_super) {
        ...
        Stage2.prototype._mouseout = function(evt) {
          var _a;
          this.setPointersPositions(evt);
  ...
  var require_BaseLayer = __commonJS({
    "node_modules/konva/lib/BaseLayer.js"(exports) {
      "use strict";
      var __extends = exports && exports.__extends || /* @__PURE__ */ (function() {
        var extendStatics = function(d, b) {
          extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
      ...
      var BaseLayer = (function(_super) {
        ...
        BaseLayer2.prototype.createPNGStream = function() {
          var c = this.canvas._canvas;
          return c.createPNGStream();
        };
        BaseLayer2.prototype.getCanvas = function() {
          return this.canvas;
        };
        BaseLayer2.prototype.getHitCanvas = function() {
          return this.hitCanvas;
        };
        BaseLayer2.prototype.getContext = function() {
          return this.getCanvas().getContext();
        };
        BaseLayer2.prototype.clear = function(bounds) {
          this.getContext().clear(bounds);
          return this;
        };
        BaseLayer2.prototype.setZIndex = function(index) {
        ...
        BaseLayer2.prototype.moveToTop = function() {
        ...
        BaseLayer2.prototype.moveUp = function() {
        ...
        BaseLayer2.prototype.moveDown = function() {
        ...
        BaseLayer2.prototype.moveToBottom = function() {
        ...
        BaseLayer2.prototype.getLayer = function() {
          return this;
        };
        BaseLayer2.prototype.hitGraphEnabled = function() {
          return true;
        };
        BaseLayer2.prototype.remove = function() {
        ...
        BaseLayer2.prototype.getStage = function() {
          return this.parent;
        };
        BaseLayer2.prototype.setSize = function(_a) {
          var width = _a.width, height = _a.height;
          this.canvas.setSize(width, height);
          this._setSmoothEnabled();
          return this;
        };
        BaseLayer2.prototype._toKonvaCanvas = function(config) {
          config = config || {};
        ...
        BaseLayer2.prototype._checkVisibility = function() {
        ...
        BaseLayer2.prototype._setSmoothEnabled = function() {
          this.getContext()._context.imageSmoothingEnabled = this.imageSmoothingEnabled();
        };
        BaseLayer2.prototype.getWidth = function() {
          if (this.parent) {
            return this.parent.width();
          }
        };
        BaseLayer2.prototype.setWidth = function() {
          Util_1.Util.warn('Can not change width of layer. Use "stage.width(value)" function instead.');
        };
        BaseLayer2.prototype.getHeight = function() {
          if (this.parent) {
            return this.parent.height();
          }
        };
        BaseLayer2.prototype.setHeight = function() {
          Util_1.Util.warn('Can not change height of layer. Use "stage.height(value)" function instead.');
        };
        BaseLayer2.prototype.getIntersection = function(pos, selector) {
          return null;
        };
        BaseLayer2.prototype.batchDraw = function() {
          var _this = this;
        ...
        BaseLayer2.prototype._applyTransform = function(shape, context, top) {
  ...
  var require_Shape = __commonJS({
    "node_modules/konva/lib/Shape.js"(exports) {
      ...
      var Shape = (function(_super) {
        ...
        Shape2.prototype._useBufferCanvas = function(caching) {
        ...
        Shape2.prototype.getClientRect = function(attrs) {
          attrs = attrs || {};
        ...
        Shape2.prototype.drawScene = function(can, top, caching, skipBuffer) {
        ...
        Shape2.prototype.drawHit = function(can, top, caching) {
  ...
  var require_Layer = __commonJS({
    "node_modules/konva/lib/Layer.js"(exports) {
      ...
      var Container_1 = require_Container();
      var Factory_1 = require_Factory();
      var BaseLayer_1 = require_BaseLayer();
      var Canvas_1 = require_Canvas();
  ...
  var require_FastLayer = __commonJS({
    "node_modules/konva/lib/FastLayer.js"(exports) {
      ...
      var FastLayer = (function(_super) {
        ...
        FastLayer2.prototype._validateAdd = function(child) {
          var type = child.getType();
          if (type !== "Shape") {
            Util_1.Util.throw("You may only add shapes to a fast layer.");
          }
        };
        FastLayer2.prototype.hitGraphEnabled = function() {
          return false;
        };
        FastLayer2.prototype.drawScene = function(can) {
          var layer = this.getLayer(), canvas = can || layer && layer.getCanvas();
          if (this.clearBeforeDraw()) {
            canvas.getContext().clear();
          }
        ...
        FastLayer2.prototype.draw = function() {
          this.drawScene();
          return this;
        };
        return FastLayer2;
      ...
      var TextPath = (function(_super) {
        ...
        TextPath2.prototype._setTextData = function() {
          ...
          var findSegmentToFitCharacter = function(c) {
            ...
            var attempts = 0;
            p1 = void 0;
            while (Math.abs(glyphWidth2 - currLen) / glyphWidth2 > 0.01 && attempts < 25) {
              attempts++;
  ...
  var require_lib = __commonJS({
    "node_modules/konva/lib/index.js"(exports, module) {
      var Konva = require_FullInternals().Konva;
  ...
  // node_modules/headbreaker/src/konva-painter.js
  var require_konva_painter = __commonJS({
    "node_modules/headbreaker/src/konva-painter.js"(exports, module) {
      var Konva;
      try {
        Konva = require_lib();
      } catch (e) {
  ...
  // node_modules/headbreaker/src/index.js
  var require_index = __commonJS({
    "node_modules/headbreaker/src/index.js"(exports, module) {
      var Pair = require_pair();
      var { anchor, Anchor } = require_anchor();
      var Puzzle = require_puzzle();
      var Piece = require_piece();
      var { Tab, Slot, None } = require_insert();
      var { NullValidator, PieceValidator, PuzzleValidator } = require_validator();
      var { Horizontal, Vertical } = require_axis();
      var Structure = require_structure();
      var Outline = require_outline();
      var Canvas = require_canvas();
      var Manufacturer = require_manufacturer();
      var { InsertSequence, ...generators } = require_sequence();
      var Metadata = require_metadata();
      var SpatialMetadata = require_spatial_metadata();
      var { vector, ...Vector } = require_vector();
      var { radius, diameter } = require_size();
      var Shuffler = require_shuffler();
      var outline = require_outline();
      var dragMode = require_drag_mode();
      var connector = require_connector();
      module.exports = {
        ...
        connector,
        painters: {
          Dummy: require_dummy_painter(),
          Konva: require_konva_painter()
        }
      };
    }
  });
