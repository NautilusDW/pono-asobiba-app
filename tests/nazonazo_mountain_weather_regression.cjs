...
assert.match(html, /styles\.css\?v=20260721-1409/, "the current Nazonazo scenery and stage games must bypass stale CSS caches");
assert.match(html, /js\/game\.js\?v=20260721-1409/, "the current Nazonazo runtime must bypass stale game-script caches");
assert.ok(
