...
async function validate(candidateSources, assetSpecs = ASSETS) {
  ...
  check(fantasyRowsPass && styleToken === "20260723-1435" && gameToken === styleToken &&
    /const CACHE_VERSION = 2353;/.test(sw) && /\/\/ v2317:/.test(sw) && /\/\/ v2316:/.test(sw) &&
...
async function main() {
  ...
  const mutations = [
    ...
    { name: "fantasy cache token rolls back", code: "fantasy-baseline-token", sources: { ...sources, html: replaceOnce(sources.html, "styles.css?v=20260723-1435", "styles.css?v=20260723-1434") }, assets: ASSETS }
  ];
