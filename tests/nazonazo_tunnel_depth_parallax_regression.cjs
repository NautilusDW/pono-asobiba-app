...
async function validate(candidateSources, assetSpecs = ASSETS) {
  ...
  check(fantasyRowsPass && styleToken === "20260722-1412" && gameToken === styleToken &&
    /const CACHE_VERSION = 2329;/.test(sw) && /\/\/ v2317:/.test(sw) && /\/\/ v2316:/.test(sw) &&
...
async function main() {
  ...
  const mutations = [
    ...
    { name: "fantasy cache token rolls back", code: "fantasy-baseline-token", sources: { ...sources, html: replaceOnce(sources.html, "styles.css?v=20260722-1412", "styles.css?v=20260722-1411") }, assets: ASSETS }
  ];
