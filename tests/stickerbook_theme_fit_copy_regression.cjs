...
assert.match(index, /styles\.css\?v=20260713-1278/, "the baked top-button UI must bypass stale CSS caches");
assert.match(index, /main\.js\?v=20260713-1278/, "the matching StickerBook behavior must bypass stale module caches");
