...
assert.match(game, /resize",\(\)=>\{invalidateSpaceObstacleLayout\(\);updateSpaceRepairVisual\(\);if\(!spaceStationSteerResume&&!quiz\.classList\.contains\("show"\)\)clampSpaceSteerOffsets\(\);\}/,
