...
async function main() {
  ...
  const mutations = [
    ...
    sourceMutation("selected image enters SW", "sw", "const CACHE_VERSION = 2321;", "const CACHE_VERSION = 2321; // branch_cat_far_town_a_worldfix_20260721.webp", "sw-critical"),
    ...
    sourceMutation("service-worker generation rolls back", "sw", "const CACHE_VERSION = 2321;", "const CACHE_VERSION = 2319;", "query-cache"),
