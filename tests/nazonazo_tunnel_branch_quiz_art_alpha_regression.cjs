...
const mutations = [
  ...
  { name: "game token stale", expected: "token-sync", mutate: c => ({ ...c, html: replaceExactlyOnce(c.html, 'js/game.js?v=20260723-1435', 'js/game.js?v=20260723-1434') }) },
  { name: "style token stale", expected: "token-sync", mutate: c => ({ ...c, html: replaceExactlyOnce(c.html, 'styles.css?v=20260723-1435', 'styles.css?v=20260723-1434') }) },
