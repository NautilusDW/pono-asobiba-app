...
const RUNTIME_TOKEN = "20260723-1421";
...
const mutations = [
  ...
  { name: "game token stale", expected: "token-sync", mutate: c => ({ ...c, html: replaceExactlyOnce(c.html, 'js/game.js?v=20260723-1421', 'js/game.js?v=20260723-1420') }) },
  { name: "style token stale", expected: "token-sync", mutate: c => ({ ...c, html: replaceExactlyOnce(c.html, 'styles.css?v=20260723-1421', 'styles.css?v=20260723-1420') }) },
