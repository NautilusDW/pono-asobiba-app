...
const RUNTIME_TOKEN = "20260722-1411";
...
const mutations = [
  ...
  { name: "game token stale", expected: "token-sync", mutate: c => ({ ...c, html: replaceExactlyOnce(c.html, 'js/game.js?v=20260722-1411', 'js/game.js?v=20260722-1410') }) },
  { name: "style token stale", expected: "token-sync", mutate: c => ({ ...c, html: replaceExactlyOnce(c.html, 'styles.css?v=20260722-1411', 'styles.css?v=20260722-1410') }) },
