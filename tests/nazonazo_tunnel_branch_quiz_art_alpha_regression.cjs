...
const RUNTIME_TOKEN = "20260722-1412";
...
const mutations = [
  ...
  { name: "game token stale", expected: "token-sync", mutate: c => ({ ...c, html: replaceExactlyOnce(c.html, 'js/game.js?v=20260722-1412', 'js/game.js?v=20260722-1411') }) },
  { name: "style token stale", expected: "token-sync", mutate: c => ({ ...c, html: replaceExactlyOnce(c.html, 'styles.css?v=20260722-1412', 'styles.css?v=20260722-1411') }) },
