...
const gameScriptIndex = html.indexOf('src="js/game.js?v=20260720');
...
assert.match(html, /styles\.css\?v=20260720/, "illustration layout needs a fresh stylesheet cache key");
