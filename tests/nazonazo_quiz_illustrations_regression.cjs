...
const gameScriptIndex = html.indexOf('src="js/game.js?v=20260715');
...
assert.match(html, /styles\.css\?v=20260715/, "illustration layout needs a fresh stylesheet cache key");
