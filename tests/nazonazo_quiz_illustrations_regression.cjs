...
const artScriptIndex = html.indexOf('src="data/quiz-art.js?v=20260721-1409');
const gameScriptIndex = html.indexOf('src="js/game.js?v=20260721-1409');
...
assert.match(html, /styles\.css\?v=20260721-1409/, "illustration layout needs a fresh stylesheet cache key");
