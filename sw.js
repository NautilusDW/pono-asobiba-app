...
const CACHE_VERSION = 1278; // v1278: Oto watches legacy sticker reward close events so next-stage openings continue on staging. | v1277: Oto next-stage transitions close the result/name gate before sticker rewards and cleanly leave stuck rhythm states. | v1276: SW update checks stay passive and no longer show a blocking in-page version prompt. | v1275: Bento rolls back generated control button/frame sprites to the previous compact CSS controls. | v1274: Oto Kero frustrated reaction uses imported fixed alpha art and left/right anger smoke.
