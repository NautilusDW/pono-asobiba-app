...
const CACHE_VERSION = 1305; // v1305: Oto rhythm menu tutorial continues into left-side line/button guidance with real falling notes. | v1304: Oto rhythm menu has first-run tutorials for song selection and block/full setup. | v1303: Oto rhythm tutorial starts with a visible overview and uses real rhythm notes for the demo. | v1300: Oto rhythm story tutorial shows the stage first, demos one falling note, and keeps prompts off controls.
