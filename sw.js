...
// play.html PAGE_CACHE_VERSION/window.PONO_SW_VERSIONと同期 (2391)。
// v2390: 「かずのゲームランド」と最初の4本（じゅんばんタッチ／
// すうじパチンコ／すうじのれっしゃ／かずだけジャンプ）を追加。
// 個別HTML/CSS/JSはnetwork-first配信のためCRITICAL_ASSETSには追加しない。
// play.html PAGE_CACHE_VERSION/window.PONO_SW_VERSIONと同期 (2390)。
...
// CRITICAL_ASSETSには追加しない。play.html PAGE_CACHE_VERSION/
// window.PONO_SW_VERSIONと同期 (2388)。
...
// 同位置で反転する月、立ち耳対垂れ耳、短い鼻対巻き鼻へ更新し、303px表示に合わせて
// 当たり判定を再配置した。ゲーム個別画像はnetwork-first配信のためCRITICAL_ASSETSには
// 追加しない。play.html PAGE_CACHE_VERSION/window.PONO_SW_VERSIONと同期 (2386)。
