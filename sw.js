...
const CACHE_VERSION = 1108; // v1108: oto UI overhaul — result modal compact + speech bubble, ⚙ moved into right-top ♪, free-mode band-group no-cutoff, bluer BG, 2-step song-then-mode select
