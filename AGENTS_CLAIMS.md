...
- 2026-07-11 - by Claude - [batch:1215-book-tier-fixes] - mojicrane/index.html, nazonazo-tunnel/index.html, starparodier/**, undersea-cave/**, sea-album/**, play.html, common/tier.js, sw.js - book tier 監査の must-fix: sub専用5ゲームに tier ガード追加 + プロフィール「あとで」導線 + 告知文修正 + sw bump。あわせてクッキング実装 (bento kitchen 系) の所在調査 (読み取りのみ)
