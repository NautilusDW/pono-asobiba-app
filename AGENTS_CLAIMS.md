...
- 2026-07-13 11:55 - by Codex - [batch:1283-decouple-shop-news] - play.html, sw.js, tests/title_news_shop_debug_regression.cjs, AGENTS_CLAIMS.md, HANDOFF.md - おしらせを公式情報だけへ戻し、ショップ更新はタイトル／ガチャ内の独立サインとデバッグ操作だけに分離 [overlap: batch:933-haptics-quick-win-phase1]
