...
- 2026-06-29 11:00 - by Claude - [batch:936-quizland-audit-fix-all] - quizland/index.html, sw.js, play.html, AGENTS_CLAIMS.md, HANDOFF.md - 監査結果 6 件 fix (不正解チップ複数赤 / 答え中ナレ停止 / キーボード対応 / ロック視覚FB / TTSタイムアウト延長 / ロック理由表示 + 軽量化)
---
