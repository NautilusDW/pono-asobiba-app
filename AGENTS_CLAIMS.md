...
- 2026-07-14 17:47 - by Codex - [batch:1296-bento-undo-focus] - bento/index.html, tests/**, sw.js, AGENTS_CLAIMS.md, HANDOFF.md - のり編集の自動復元説明中だけ「とりけす」を有効表示し、接続中ボタンへ青い案内枠を単一表示。履歴操作を防ぐ既存guardと通常undo挙動は維持 [overlap: batch:1285-bento-shop-nori-set, batch:1281-analytics-phase1, batch:1295-title-screen-tour-flicker-fix]
