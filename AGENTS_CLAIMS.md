...
- 2026-07-04 - by Claude - [batch:938-pono-sw-version-inject] - play.html, survey.html, sw.js, AGENTS_CLAIMS.md - rating survey で swVersion が常時空文字になる不具合を修正 (play.html/survey.html に window.PONO_SW_VERSION 注入 + sw v1952→v1953)
