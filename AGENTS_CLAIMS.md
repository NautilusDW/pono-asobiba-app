...
- 2026-07-01 10:11 - by Codex - [batch:1012-sticker-alpha-bounds-no-shadow] - Prototypes/StickerBookThreeJS/**, play.html, sw.js, AGENTS_CLAIMS.md, HANDOFF.md - シール透明余白を除外して貼りサイズ/選択枠を一致させ、貼り付け影を一旦撤去 [overlap: batch:860-data-export-import, batch:877-gacha-tray-mask-lower]
