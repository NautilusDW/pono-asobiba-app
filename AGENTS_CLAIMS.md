...
- 2026-07-13 10:20 - by Codex - [batch:1282-news-shop-debug] - play.html, sw.js, tests/**, AGENTS_CLAIMS.md, HANDOFF.md - おしらせのサンプル記事と公式／おみせのカテゴリUI、ショップ更新サイン、管理デバッグモード用の表示・未読切替を実装 [overlap: batch:933-haptics-quick-win-phase1]
