...
- 2026-07-05 - by Claude - [batch:952-zukan-hide-museum-desc] - Prototypes/StickerBookThreeJS/**, Prototypes/StickerExhibitionCarousel/**, sw.js, AGENTS_CLAIMS.md - 図鑑モード凍結 (COLLECTION_MODE_ENABLED flag) + ミュージアムシール説明文 (STICKER_DESC + #detailDesc) + sw bump
