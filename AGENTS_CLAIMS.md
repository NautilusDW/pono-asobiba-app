...
- 2026-07-15 18:15 - by Codex - [batch:1305-slide-worldboard-redesign] - slide/index.html, tests/slide_16x9_regression.cjs, tests/slide_left_to_right_regression.cjs, tests/slide_worldboard_visual_regression.cjs, sw.js, AGENTS_CLAIMS.md, HANDOFF.md - みちつなぎを世界一体型の盤面へ再設計し、HUD縮小・主役拡大・接続演出・操作状態を改善する
