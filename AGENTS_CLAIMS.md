...
- 2026-06-29 10:08 - by Codex - [batch:936-bento-nori-crop-fix] - bento/index.html, assets/images/bento/free-layout/*nori*.png, AGENTS_CLAIMS.md, HANDOFF.md - 海苔パーツの切り抜き・左右ヒゲ・顔セット定義を修正 [overlap: batch:885-difficulty-label-phase3-fix]
---
