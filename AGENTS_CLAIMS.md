...
- 2026-07-13 - by Claude - [batch:1280-data-analytics-plan] - docs/**, docs/beta/**, assets/_archive/beta/**, AGENTS_CLAIMS.md - 子供の遊びデータ収集プラン策定 + β配布文書の文言整合修正 (計画書 588 行 + β文書 9 箇所) [overlap: batch:931-sticker-book-engagement-research-v2 (docs/**)]
...
- 2026-07-14 - by Claude - [batch:1300-avatar-tier-gating] - common/tier.js, play.html, sw.js, tests/**, AGENTS_CLAIMS.md, HANDOFF.md - プロフィールのアバター(40プリセット)選択に tier ゲーティング追加 (free=4件/book=10件/app=全40件、既存 .tier-locked グレーアウト+🔒 パターン再利用、鍵メッセージ文言統一)。fable設計+sonnet5実装+クロスレビューのマルチエージェントworkflow [overlap: batch:tier-v3-phase1 (common/tier.js), batch:1131-avatar-40-fullbody-presets (play.html AVATAR_PRESETS), batch:1295-title-screen-tour-flicker-fix (play.html/sw.js)]
