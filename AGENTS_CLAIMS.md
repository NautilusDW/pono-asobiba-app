...
- 2026-07-23 22:34 - by Codex - [batch:1442-hyokkori-combo-mask-stage-check] - hyokkori-hightouch/**, tests/e2e/hyokkori/**, tests/hyokkori_hightouch_regression.cjs, sw.js, HANDOFF.md, AGENTS_CLAIMS.md - 現行コンボ得点式を確認し、右上の月／光がクロップされるマスク不具合を画面サイズ別に修正。5地点計画（きのこ／つきあかり未実装）も正本と照合 [overlap: batch:1437-machizukuri-new-feature, batch:1440-guragura-doll-weight-v3-ui, batch:1441-guragura-round-review-fixes (sw.js/AGENTS_CLAIMS.md)]
