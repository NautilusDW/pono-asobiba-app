...
- 2026-07-04 - by Claude - [batch:937-onegai-opening-first-frame] - bento/**, sw.js, play.html, AGENTS_CLAIMS.md - お願いモードのオープニング発火順修正 (ボタン押下→オープニング→ゲーム画面) + オープニング初期描画のマスク未着装フラッシュを 1 枚合成で解消
