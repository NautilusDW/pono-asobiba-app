...
- 2026-06-30 06:00 - by Claude - [batch:968-quizland-layout-persistence-final] - common/layout/layout-editor.js, common/layout/layout-applier.js, quizland/saved-layout-frozen.json (新規), quizland/index.html, sw.js, play.html - Fix #1 (line 660 snapshot base-key 強制出力) + Option B (frozen 並列層 + 🔒 Lock button) + cache TTL 短縮
