...
- 2026-07-23 12:04 - by Codex - [batch:1430-hatake-sign-angle-mark-layout] - hatake-nikki/**, assets/images/hatake-nikki/**, tmp/alpha_pending/1430-hatake-sign-angle-mark-layout/**, tests/hatake_nikki_regression.cjs, tests/e2e/hatake/**, HANDOFF.md, AGENTS_CLAIMS.md - `green.png` を明示参照して立て札のアイソメ角度を再生成し、全区画で同一相対アンカー＋微小な固定傾きへ統一。水マークを畝上の右上寄りへ大型化、芽を中央へ、奥区画の上頂点クリップを解消する。sw.js/play.htmlは並走dirty保護のため対象外
...
- 2026-07-23 - by Codex - [batch:1428-hyokkori-central-combo-lane] - hyokkori-hightouch/**, assets/images/hyokkori-hightouch/**, tmp/alpha_pending/1428-hyokkori-central-combo-lane/**, tests/hyokkori_hightouch_regression.cjs, tests/e2e/hyokkori/**, sw.js, play.html, HANDOFF.md, AGENTS_CLAIMS.md - 花壇・ひかりのたね表示を撤去し、上下2段を離した中央コンボレーンと背景になじむ共通開口へ整理。GPT Image 2製16:9背景を新規生成し、直前成功穴の除外ルールだけ内部で維持する [overlap: batch:1427-hatake-signs-wet-feedback, batch:1426-guragura-pan-item-pointer-events-fix, batch:1423-guragura-startbtn-fix-round2]
