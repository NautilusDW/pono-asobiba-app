...
- 2026-07-05 - by Claude - [batch:954-museum-sticker-size-normalize] - Prototypes/StickerExhibitionCarousel/**, scripts/**, sw.js, play.html, AGENTS_CLAIMS.md, HANDOFF.md - ミュージアムのシール表示サイズを不透明ピクセル実面積ベースで正規化 (リス等の過大表示修正、レア度別倍率+クランプ) + sw bump
