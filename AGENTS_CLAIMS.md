...
- 2026-06-27 13:50 - by Claude - [batch:863-perf-image-loading] - 調査のみ (read-only) - 全体的な描画パフォーマンス: 画像が上から順次バラバラ表示される原因究明とプリロード戦略提案
- 2026-06-27 14:00 - by Claude - [batch:864-shop-bgm-double] - play.html, sw.js - こもれびや shop の play-bgm 二重再生バグ修正 (daily-gacha pattern 流用)
