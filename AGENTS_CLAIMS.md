...
- 2026-07-01 09:15 - by Codex - [batch:1009-sticker-peel-scale-backside] - Prototypes/StickerBookThreeJS/**, play.html, sw.js, AGENTS_CLAIMS.md, HANDOFF.md - シール貼りの初期サイズ統一、透明抜け、上下めくれ、裏面表示を改善 [overlap: batch:860-data-export-import, batch:877-gacha-tray-mask-lower]
