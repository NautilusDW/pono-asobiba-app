...
- 2026-07-11 - by Claude - [batch:1216-tier-rename-sub-to-app] - common/tier.js, play.html, 各ゲーム HTML/JS の tier 判定箇所, docs/**, AGENTS.md, CLAUDE.md, memory/**, sw.js - 買い切り方針に伴い tier 名 'sub' → 'app' へ全面リネーム (挙動不変、free/book/app の3値へ)
