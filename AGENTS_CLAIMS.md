...
- 2026-07-04 - by Claude - [batch:937-star-modal-hidden-fix] - common/rating-modal.css, common/rating-modal.js, sw.js, play.html, AGENTS_CLAIMS.md - ごかんそう ★タップ後 thanks/CTA 不可視の脆さを CSS backwards-fill 撤廃 + [hidden] 明示リセット + JS removeAttribute 保険で修正 (sw v1951→v1952)
