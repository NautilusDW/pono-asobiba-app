...
# Bento NPC Araiguma / Shika No White Eyes Raw

- Batch: `488_bento_npc_araiguma_shika_no_white_eyes_raw`
- 目的: user 指摘「アライグマと鹿だけやり直して、白目はいらない」を反映。
...
- 目は黒から濃茶の点目に寄せ、白い白目・白い光点・星目を避ける。
...
- `npc_araiguma_counter_5expressions_no_white_eyes_raw.png`
- `npc_shika_counter_5expressions_no_white_eyes_raw.png`
