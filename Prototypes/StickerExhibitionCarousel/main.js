...
const FRAME_BASE_URL = new URL("./assets/sticker-carousel-frame-cute-20260713.webp", BASE_URL);
const STATE_KEY = "pono_game_stickers_v1";
const SILHOUETTE_ALPHA_THRESHOLD = 36;
const SILHOUETTE_MASK_MAX_SIZE = 300;

function captureAwareNavigationUrl(relativeUrl) {
  const nextUrl = new URL(relativeUrl, BASE_URL);
