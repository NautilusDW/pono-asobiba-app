...
const QUIZLAND_QUESTIONS = {
  ...
  food: [
    ...
    { level:1, type:'emoji_name', category:'food', emoji:'🍑', q:'これは なに？', answer:0, choices:['もも','りんご','バナナ','いちご'] },
    { level:1, type:'emoji_name', category:'food', emoji:'🍒', q:'これは なに？', answer:2, choices:['いちご','もも','さくらんぼ','ぶどう'] },
    ...
    { level:2, type:'emoji_name', category:'food', emoji:'🥕', q:'これは なに？', answer:0, choices:['にんじん','だいこん','トマト','かぼちゃ'] },
    { level:2, type:'emoji_name', category:'food', emoji:'🍄', q:'これは なに？', answer:2, choices:['キャベツ','ブロッコリー','きのこ','たまねぎ'] },
    { level:2, type:'emoji_name', category:'food', emoji:'🍋', q:'これは なに？', answer:1, choices:['みかん','レモン','バナナ','りんご'] },
    { level:3, type:'emoji_name', category:'food', emoji:'🥑', q:'これは なに？', answer:0, choices:['アボカド','メロン','キウイ','なし'] },
    { level:3, type:'emoji_name', category:'food', emoji:'🫐', q:'これは なに？', answer:1, choices:['ぶどう','ブルーベリー','さくらんぼ','くろまめ'] },
    { level:3, type:'emoji_name', category:'food', emoji:'🥝', q:'これは なに？', answer:2, choices:['なし','レモン','キウイ','メロン'] },
    { level:3, type:'emoji_name', category:'food', emoji:'🌽', q:'これは なに？', answer:0, choices:['とうもろこし','たけのこ','にんじん','だいこん'] },
    { level:3, type:'emoji_name', category:'food', emoji:'🫛', q:'これは なに？', answer:1, choices:['きゅうり','えだまめ','レタス','アスパラ'] }
  ],
  ...
  vehicle: [
    ...
    { level:1, type:'emoji_name', category:'vehicle', emoji:'🚲', q:'これは なに？', answer:1, choices:['オートバイ','じてんしゃ','キックボード','スクーター'] },
    { level:1, type:'emoji_name', category:'vehicle', emoji:'🚕', q:'これは なに？', answer:0, choices:['タクシー','くるま','バス','ちかてつ'] },
    ...
    { level:2, type:'emoji_name', category:'vehicle', emoji:'🚀', q:'これは なに？', answer:0, choices:['ロケット','ひこうき','UFO','たこあげ'] },
    { level:2, type:'emoji_name', category:'vehicle', emoji:'🚑', q:'これは なに？', answer:2, choices:['しょうぼうしゃ','パトカー','きゅうきゅうしゃ','トラック'] },
    { level:2, type:'emoji_name', category:'vehicle', emoji:'🚓', q:'これは なに？', answer:1, choices:['しょうぼうしゃ','パトカー','きゅうきゅうしゃ','バス'] },
    { level:3, type:'emoji_name', category:'vehicle', emoji:'🚁', q:'これは なに？', answer:0, choices:['ヘリコプター','ひこうき','ロケット','グライダー'] },
    { level:3, type:'emoji_name', category:'vehicle', emoji:'🚜', q:'これは なに？', answer:1, choices:['くるま','トラクター','トラック','バス'] },
    { level:3, type:'emoji_name', category:'vehicle', emoji:'⛵', q:'これは なに？', answer:2, choices:['ふね','ボート','ヨット','カヌー'] },
    { level:3, type:'emoji_name', category:'vehicle', emoji:'🛸', q:'これは なに？', answer:0, choices:['UFO','ロケット','ひこうき','ヘリコプター'] },
    { level:3, type:'emoji_name', category:'vehicle', emoji:'🛩️', q:'これは なに？', answer:0, choices:['ちいさい ひこうき','ロケット','グライダー','ヘリコプター'] }
  ],
  ...
  dino: [
    ...
    { level:2, type:'emoji_name', category:'dino', emoji:'🦕', hint:'せなかに たてがみ みたいな ほね！',
      q:'この きょうりゅうは？', answer:3, choices:['ブラキオサウルス','トリケラトプス','プテラノドン','ステゴサウルス'] },
    { level:2, type:'emoji_name', category:'dino', emoji:'🦕', hint:'くびが とても とても ながい！',
      q:'この きょうりゅうは？', answer:1, choices:['ティラノサウルス','ブラキオサウルス','トリケラトプス','ステゴサウルス'] },
    { level:2, type:'emoji_name', category:'dino', emoji:'🦕', hint:'そらを とんでいた！はねが ある！',
      q:'この きょうりゅうは？', answer:1, choices:['ティラノサウルス','プテラノドン','トリケラトプス','ブラキオサウルス'] },
    { level:2, type:'emoji_name', category:'dino', emoji:'🦕', hint:'うみのなかを およいでいた！くびが ながい！',
      q:'この きょうりゅうは？', answer:2, choices:['ブラキオサウルス','ステゴサウルス','プレシオサウルス','ティラノサウルス'] },
    { level:2, type:'emoji_name', category:'dino', emoji:'🦖', hint:'せなかに ほね（ひれ）がある！',
      q:'この きょうりゅうは？', answer:0, choices:['スピノサウルス','ティラノサウルス','アロサウルス','ブラキオサウルス'] },
    { level:2, type:'emoji_name', category:'dino', emoji:'🦖', hint:'すばやく はしった にあしの きょうりゅう！',
      q:'この きょうりゅうは？', answer:3, choices:['ブラキオサウルス','トリケラトプス','スピノサウルス','ヴェロキラプトル'] },
    { level:2, type:'emoji_name', category:'dino', emoji:'🦕', hint:'こうらの ような よろいで からだを まもる！',
  ...
  animal: [
    ...
    { level:1, type:'emoji_name', category:'animal', emoji:'🐰', q:'これは なに？', answer:2, choices:['いぬ','ねこ','うさぎ','くま'] },
    { level:1, type:'emoji_name', category:'animal', emoji:'🐹', q:'これは なに？', answer:2, choices:['ねこ','リス','ハムスター','うさぎ'] },
    { level:1, type:'emoji_name', category:'animal', emoji:'🐻', q:'これは なに？', answer:1, choices:['パンダ','くま','たぬき','いのしし'] },
    { level:1, type:'emoji_name', category:'animal', emoji:'🐮', q:'これは なに？', answer:1, choices:['うま','うし','ひつじ','ぶた'] },
    ...
    { level:2, type:'emoji_name', category:'animal', emoji:'🐺', q:'これは なに？', answer:2, choices:['いぬ','キツネ','おおかみ','タヌキ'] },
    { level:2, type:'emoji_name', category:'animal', emoji:'🦊', q:'これは なに？', answer:1, choices:['いぬ','キツネ','タヌキ','おおかみ'] },
    { level:2, type:'emoji_name', category:'animal', emoji:'🦓', q:'これは なに？', answer:1, choices:['うま','シマウマ','らくだ','きりん'] },
    { level:2, type:'emoji_name', category:'animal', emoji:'🦏', q:'これは なに？', answer:2, choices:['ゾウ','カバ','サイ','スイギュウ'] },
