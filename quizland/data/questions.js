...
const QUIZLAND_QUESTIONS = {
  ...
  shape_name: [
    ...
    { level:3, type:'shape_name', shape:'star',      q:'ほしと しかくでは どちらが かどが おおい？', answer:0, choices:['ほし','しかく','おなじ','どちらも かどが ない'] },
  ...
  trivia: [
    ...
    { level:3, type:'trivia', category:'trivia',
      q:'カバの からだから でる ピンクいろの えきは なんの やくわり？',
      hint:'びっくりな ちからが あるよ！',
      answer:0, choices:['ひやけどめに なる','ちが でている','たべものに なる','みずを はじく'] ,
      detail:'カバの からだから でる ピンクの えきは ひやけどめに なるよ。ちが でてるんじゃ ないよ！'}
  ],
  ...
  body: [
    ...
    { level:3, type:'trivia', category:'body',
      ...
      answer:1, choices:['うごけない','やすんで げんきを ためている','たべている','はしっている'] ,
