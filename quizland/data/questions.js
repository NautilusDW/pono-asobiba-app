...
const QUIZLAND_QUESTIONS = {
  ...
  weather: [
    ...
    { level:3, type:'trivia', category:'weather',
      img:'stage_weather_river_steam.png',
    ...
    { level:3, type:'trivia', category:'weather',
      img:'stage_weather_winter_breath.png',
  ...
  trivia: [
    ...
    { level:2, type:'trivia', category:'trivia',
      img:'stage_trivia_sleeping_bear_cave.png',
      img_word:'bear_winter_cave_entrance.png',
      img_answer:'stage_trivia_sleeping_bear_cave.png',
    ...
    { level:2, type:'trivia', category:'trivia',
      img:'stage_trivia_giraffe_full.png',
    ...
    { level:3, type:'trivia', category:'trivia',
      img:'stage_trivia_lion_osu_silhouette.png',
      img_word:'stage_trivia_lion_osu_silhouette.png',
      img_answer:'stage_trivia_lion_osu_mesu_compare.png',
