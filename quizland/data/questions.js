...
const QUIZLAND_QUESTIONS = {
  ...
  weather: [
    ...
    { level:1, type:'trivia', category:'weather',
      img:'stage_weather_sky_question.png', framed:true,
      img_answer:'stage_weather_cloud_sky.png', framed_answer:true,
    ...
    { level:2, type:'trivia', category:'weather',
      img:'stage_weather_morning_clear.png', framed:true,
      img_answer:'stage_weather_distant_mist.png', framed_answer:true,
    ...
    { level:2, type:'trivia', category:'weather',
      choiceTextRevision:'20260609-puddle-rain-time',
      img:'stage_weather_puddle.png', framed:true,
      q:'みずたまりは いつ できる？',
      answer:0, choices:['あめのとき','はれのとき','ゆきのとき','よるだけ'] ,
      detail:'あめがふると みずがたまるよ！'},
    { level:2, type:'trivia', category:'weather',
      img:'stage_weather_thunder.png', framed:true,
      q:'かみなりは なぜ なる？',
    ...
    // sprint-14 結線済み (2026-05-08): reveal pair で出題=シルエット → 正解後=既存
    { level:2, type:'trivia', category:'weather',
      img:'stage_weather_rain_ground.png', framed:true,
      img_answer:'stage_weather_rain_from_cloud.png', framed_answer:true,
      q:'あめは どこから ふってくる？',
    ...
    { level:3, type:'trivia', category:'weather',
      img:'stage_weather_winter_breath.png', framed:true,
    ...
    { level:3, type:'trivia', category:'weather',
      ...
      img:'stage_weather_falling_snow.png',
      img_answer:'stage_weather_snowflake_big.png',
  ...
  opposite: [
    ...
    { level:2, type:'opposite', category:'opposite', word:'つよい',   q:'「つよい」の はんたいは？',   answer:0, choices:['よわい','おもい','ちいさい','おそい'],
      img_word:'opposite/tsuyoi.png', img_answer:'opposite/yowai.png' },
    ...
    { level:3, type:'opposite', category:'opposite', word:'おしえる',   q:'「おしえる」の はんたいは？',   answer:2, choices:['はなす','きく','ならう','よむ'],
      img_word:'opposite/oshieru.png', img_answer:'opposite/narau.png' }
  ],
  ...
  trivia: [
    ...
    { level:1, type:'trivia', category:'trivia',
      img:'stage_trivia_meowing_cat.png',
      q:'ねこは なんて なく？',
      answer:2, choices:['ワンワン','モーモー','ニャーニャー','コケコッコー'] ,
      detail:'ねこは「ニャー」と なくよ。きげんが いいと「ゴロゴロ」も するよ！'},
    // sprint-14 結線済み (2026-05-08): reveal pair で出題=シルエット → 正解後=既存
    { level:1, type:'trivia', category:'trivia',
      img:'stage_trivia_elephant_silhouette.png', framed:true,
    ...
    // sprint-14 結線済み (2026-05-08): reveal pair で出題=シルエット → 正解後=既存
    { level:1, type:'trivia', category:'trivia',
      img:'stage_trivia_winter_sky_only.png', framed:true,
      img_answer:'stage_trivia_snowy_landscape.png', framed_answer:true,
      q:'ふゆに そらから ふってくる しろい ものは？',
      answer:1, choices:['あめ','ゆき','すな','こおり'] ,
      detail:'ゆきは くもの なかで みずが こおって おちてくるよ！'},
    // sprint-14 結線済み (2026-05-08): reveal pair で出題=シルエット → 正解後=既存
    { level:1, type:'trivia', category:'trivia',
      img:'stage_trivia_egg_unhatched.png', framed:true,
      img_answer:'stage_trivia_adult_chicken.png',
    ...
    // sprint-14 結線済み (2026-05-08): reveal pair で出題=シルエット → 正解後=既存
    { level:1, type:'trivia', category:'trivia',
      img:'stage_trivia_seed_in_dirt.png', framed:true,
      img_answer:'stage_trivia_seed_germinate.png', framed_answer:true,
    ...
    { level:2, type:'trivia', category:'trivia',
      img:'stage_trivia_octopus_8legs_silhouette.png',
      img_answer:'stage_trivia_octopus_8legs_color.png',
      q:'タコの あしは なんぼん？',
    ...
    { level:2, type:'trivia', category:'trivia',
      img:'stage_trivia_sleeping_bear_cave.png', framed:true,
      img_word:'bear_winter_cave_entrance.png',
      img_answer:'stage_trivia_sleeping_bear_cave.png', framed_answer:true,
      q:'ふゆに ねむる（とうみん）どうぶつは どれ？',
      answer:2, choices:['ゾウ','ライオン','クマ','キリン'] ,
      detail:'クマは ふゆの あいだ たべものを さがさず ねむって すごすよ！'},
    // sprint-14 結線済み (2026-05-08): reveal pair で出題=シルエット → 正解後=既存
    { level:2, type:'trivia', category:'trivia',
      img:'stage_trivia_earthworm_dirt_only.png', framed:true,
    ...
    { level:2, type:'trivia', category:'trivia',
      img:'stage_trivia_koala_food_choices.png',
      img_answer:'stage_trivia_koala_eucalyptus.png',
      q:'コアラが たべるものは？',
      answer:2, choices:['バナナ','たけのこ','ユーカリの は','りんご'] ,
      detail:'ユーカリの はは どくが あるけど、コアラだけ たべられるよ！'},
    // sprint-13 結線済み (2026-05-08): reveal pair (giraffe_full → neck_bones)
    { level:2, type:'trivia', category:'trivia',
      img:'stage_trivia_giraffe_full.png', framed:true,
      img_answer:'stage_trivia_giraffe_neck_bones.png',
      q:'キリンの くびの ほねは いくつ？',
      answer:0,
    ...
    { level:3, type:'trivia', category:'trivia',
      img:'stage_trivia_fish_silhouette.png',
      img_answer:'stage_trivia_jinbeizame_answer.png',
      q:'せかいで いちばん おおきい さかなは？',
      hint:'クジラは さかなじゃなくて ほにゅうるい！',
      answer:2, choices:['マグロ','クジラ','ジンベイザメ','サメ'] ,
      detail:'ジンベイザメは やさしい さかなで プランクトンを たべるよ！'},
    { level:3, type:'trivia', category:'trivia',
      img:'stage_trivia_dolphin.png',
      img_answer:'stage_trivia_dolphin_whale_answer.png',
      q:'イルカは なにの なかま？',
    ...
    { level:3, type:'trivia', category:'trivia',
      ...
      img_answer:'stage_trivia_bluewhale_answer.png',
    ...
    { level:3, type:'trivia', category:'trivia',
      img:'kusa.png',
      img_word:'banana_tree_solo.png',
      img_answer:'banana_kusa_compare.png',
    ...
    { level:3, type:'trivia', category:'trivia',
      img:'tako.png',
      img_word:'tako_q.png',
      img_answer:'tako_3hearts.png',
      q:'タコの しんぞうは いくつ ある？',
      hint:'タコは 3つも あるんじゃ！',
      answer:2, choices:['1つ','2つ','3つ','4つ'] ,
      detail:'2つは えらに ちを おくり、1つが からだに ちを おくるよ！'},
    { level:3, type:'trivia', category:'trivia',
      img:'stage_trivia_flamingo.png',
      img_word:'stage_trivia_flamingo_alone.png',
      img_answer:'stage_trivia_flamingo.png',
  ...
  body: [
    ...
    { level:1, type:'trivia', category:'body',
      img:'finger.png',
      img_answer:'stage_body_five_fingers_numbered.png',
      q:'かたての ゆびは なんぼん？',
    ...
    { level:2, type:'trivia', category:'body',
      img:'stage_body_munching.png', framed:true,
    ...
    { level:2, type:'trivia', category:'body',
      img:'stage_body_deep_breath.png', framed:true,
