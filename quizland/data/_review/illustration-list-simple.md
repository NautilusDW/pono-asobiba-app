...
| 既存ファイル | 動物 | 用途 |
|---|---|---|
| `assets/images/quizland/illust/choice/zou.png`  | ぞう       | Lv1 はな / Lv3 おおきい |
| `assets/images/quizland/illust/choice/neko.png` | ねこ       | Lv1 鳴き声 |
| `assets/images/word/usagi.png`  | うさぎ     | Lv1 みみ |
| `assets/images/quizland/illust/choice/kuma.png`  | クマ       | Lv2 ふゆねむる |
| `assets/images/quizland/illust/choice/kirin.png` | キリン     | Lv2 ねむる時間 |
| `assets/images/quizland/illust/choice/lion.png`  | ライオン   | Lv3 たてがみ |
