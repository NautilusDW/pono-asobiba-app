...
- **【未対処懸案 2026-05-12】 chip-label v968 4 段防御で残るバグ + v969 attempt 破棄**: [memory/project_chip_label_v968_residual.md](memory/project_chip_label_v968_residual.md) — 288×240 + 改行混入が v968 で残存、 v969 attempt (全 element-child 除去 + load-time sanitizer + 全角 2-pass regex) は 2026-05-12 rebase 混乱で broken 判定で全破棄、 次タスクで PoC test 先行で再着手
