...
`bento/kitchen.html`（自己完結 HTML + inline CSS/JS、IIFE 構成、約 3087 行、sw v414 時点）。 ユーザーが既存 `bento/index.html` を開く前にここを通る想定。
...
- **chop メカニクス モデル A→B 変更 (startX = 最初の切り口、endX = 最後の切り口、ユーザー直感通り)**: **v414（現行）**
