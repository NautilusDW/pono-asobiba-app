...
`bento/kitchen.html`（自己完結 HTML + inline CSS/JS、IIFE 構成、約 3024 行、sw v410 時点）。 ユーザーが既存 `bento/index.html` を開く前にここを通る想定。
...
- 包丁 startX/endX editor 化 (青/赤 縦線 marker、 v408 定型パターン × 2): **v410（現行）**
