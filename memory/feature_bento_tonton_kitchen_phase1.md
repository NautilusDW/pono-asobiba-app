...
`bento/kitchen.html`（自己完結 HTML + inline CSS/JS、IIFE 構成、約 2730 行、sw v402 時点）。 ユーザーが既存 `bento/index.html` を開く前にここを通る想定。
...
- chopY-marker 可視化 + drag 不能解消 (pointer-events:auto、48×48 + ⬇ アイコン): **v402（現行）**
