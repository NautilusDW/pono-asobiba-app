...
- **話者は博士キャラで統一** (owl preset = 年配おじいさん風と整合): VOICEVOX 話者は「ちび式じい」最有力 / 「玄野武宏 やさしい」「青山龍星」候補。全 907 ファイル同一話者で生成、選択肢ごとの話者切り替え禁止。テスト発注 (`COWORK-TEST-ORDER.md`) で 1〜2 候補に絞り → ユーザー試聴で確定 → フル発注は確定話者で全件生成
