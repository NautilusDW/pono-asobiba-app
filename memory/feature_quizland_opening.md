...
| # | kind | bg | 内容 |
|---|------|-----|------|
| 1 | narration | `OP_BG.webp` (森の家・外観、**シャープ／ブラー無し**) | **ナレーションは全文 Bold** (font-weight: bold @ `.op-narration` base)、**全行 黒** (2026-05-08 修正で seg2 の赤強調を全て emphasis: false に戻した。子供向けで赤強調は不要、Bold で十分メリハリが出るため)。seg1 (3行): もりの おくに… すんでいます。/ seg2 (2行): ポノは、なかよしの はかせと、/ いつもの なぞなぞで あそぶために やってきました。 |
