...
| 2 | dialogue  | `OP_BG02.webp` (**博士の家の屋内**、is-static-blur: scale 1.08 + blur 10px) | Pono panel 既定 = `dance_hi.webp`、**hakase line で `pono_001.webp` (neutral 立ち姿、聞き役)、pono line で `dance_smile.webp` に override**、博士 = `owl_professor_guide.webp`、台詞「ほっほっほ…ポノか。よくきたのう」「はかせ、あそびに きたよ！」 |
