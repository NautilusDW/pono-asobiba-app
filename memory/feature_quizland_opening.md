...
## くるみちゃん組み込み (sw v921+ / クロスレビュー反映 v922+ / 13 variants 管理 v923+ / クロスレビュー C HIGH3+MED4 反映 v924+ / 左ペイン Kurumi サムネ + シナリオ speaker 拡張 v925+)
...
### 組み込み箇所まとめ (variant 確定値: sw v923+、 editor 拡張は v924/v925 で進化)
...
- **`quizland/saved-layout.json`** (sw v923+ で 13 variants 化、 v924 でクロスレビュー C 修正、 v925 で editor 左ペイン Kurumi サムネ + シナリオ speaker 拡張): `__op_layout.{B,C,D}.kurumi` に slot + **perVariant 13 entries** を保持 (B 280×380 / C 380×520 / D 460×630、 aspect 0.73、 右寄せ初期値、 全 variant が `kurumi_001` と同値で初期化)
